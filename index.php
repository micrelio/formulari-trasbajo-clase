        ...
        <div id='form-content'>
            ...
            <form role="form" action="" method="post" id="formulario" name="formulario" class="">
                ...
                <fieldset class="fieldset salida horizontal" id="generoso">
                    ...
                    <div>
                        <label>
                            <input class="seleccion" id="generoso1" type="radio" name="¿Te consideras generoso?"
                                value="1">
                            1
                        </label>
                        <label>
                            <input class="seleccion" id="generoso2" type="radio" name="¿Te consideras generoso?"
                                value="2">
                            2
                        </label>
                        <label>
                            <input class="seleccion" id="generoso3" type="radio" name="¿Te consideras generoso?"
                                value="3">
                            3
                        </label>
                        <label>
                            <input class="seleccion" id="generoso4" type="radio" name="¿Te consideras generoso?"
                                value="4">
                            4
                        </label>
                        <label>
                            <input class="seleccion" id="generoso5" type="radio" name="¿Te consideras generoso?"
                                value="5">
                            5
                        </label>
                    </div>
                ...
                <fieldset class="fieldset salida" id="humilde">
                    ...
                    <div>
                        <label>
                            <input class="seleccion" id="humilde1" type="radio" name="¿Eres una persona humilde?"
                                value="1">
                            1
                        </label>
                        <label>
                            <input class="seleccion" id="humilde2" type="radio" name="¿Eres una persona humilde?"
                                value="2">
                            2
                        </label>
                        <label>
                            <input class="seleccion" id="humilde3" type="radio" name="¿Eres una persona humilde?"
                                value="3">
                            3
                        </label>
                        <label>
                            <input class="seleccion" id="humilde4" type="radio" name="¿Eres una persona humilde?"
                                value="4">
                            4
                        </label>
                        <label>
                            <input class="seleccion" id="humilde5" type="radio" name="¿Eres una persona humilde?"
                                value="5">
                            5
                        </label>
                    </div>
                    ...
                    <div class="vertical">
                        ...
                        <label>
                            <input class="seleccion" id="honestidad" type="radio"
                                name="¿Cuáles son los valores que más destacas en el ser humano?" value="honestidad">
                            Honestidad
                        </label>
                        <label>
                            <input 
